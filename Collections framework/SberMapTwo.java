public class SberMapTwo<K , V> {
    ...
    public static void main(String[] args) {
        SberMapTwo<String, String> sberMapTwo = new SberMapTwo<>();

        sberMapTwo.put("Hello world", "From russia");
        sberMapTwo.put("Test1", "It is from test1");

        System.out.println(sberMapTwo.get("Hello world"));
        System.out.println(sberMapTwo.get("Test1"));
    }
}
